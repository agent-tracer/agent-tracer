import { AGENT_TRACER_ATTR, SEMCONV_ATTR } from "@agent-tracer/kernel";
...
import { RULE_EXPECTATION_KIND, RULE_SEVERITY, VERDICT_STATUS, type RuleExpectation } from "@agent-tracer/kernel";
import { EventEntity } from "~tracer-model/timeline/event/event.entity.js";

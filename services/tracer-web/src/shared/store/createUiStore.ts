...
import {
  ...
  type SelectionSlice,
} from "~tracer-web/shared/store/slices/selectionSlice.js";
import {
  createViewSlice,
  type MainView,
  type ViewSlice,
...
import {
  createLayoutSlice,
  type LayoutSlice,
} from "~tracer-web/shared/store/slices/layoutSlice.js";
import {
  createThemeSlice,
  type ThemeSlice,
} from "~tracer-web/shared/store/slices/themeSlice.js";
import {
  createGuidanceLocaleSlice,
  type GuidanceLocaleSlice,
} from "~tracer-web/shared/store/slices/guidanceLocaleSlice.js";
import { normalizeGuidanceLocale } from "~tracer-web/shared/guidance.js";

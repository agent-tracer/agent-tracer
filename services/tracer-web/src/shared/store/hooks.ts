import { useUiStore } from "~tracer-web/shared/store/UiStoreProvider.js";
import type {
  InspectorTab,
  MainView,
  VisibleLane,
...
import type { Theme } from "~tracer-web/shared/store/slices/themeSlice.js";
import type { GuidanceLocale } from "~tracer-web/shared/guidance.js";
import type { EventId, TagId, TaskId } from "~tracer-web/shared/identity.js";

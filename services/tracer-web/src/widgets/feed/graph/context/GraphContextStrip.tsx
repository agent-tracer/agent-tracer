...
import { buildContextTrajectory } from "~tracer-web/widgets/feed/lib/extraction/extract-context-trajectory.js";
import { buildModelSpans } from "~tracer-web/widgets/feed/lib/extraction/extract-model-spans.js";
import { useGuidance } from "~tracer-web/shared/store/index.js";
import { GuidanceText, Tooltip } from "~tracer-web/shared/ui/index.js";
import { msToLeftPercent, type TimeRange } from "~tracer-web/widgets/feed/graph/model/time-range.js";
import {
  LANE_LABEL_WIDTH,
  TRACK_LEFT_PADDING,
} from "~tracer-web/widgets/feed/graph/model/track-geometry.js";
import { ContextTrajectoryChart } from "~tracer-web/widgets/feed/graph/context/ContextTrajectoryChart.js";
import { ModelSpanBand } from "~tracer-web/widgets/feed/graph/context/ModelSpanBand.js";
import {
  CONTEXT_STRIP_HEIGHT,
  contextStroke,
} from "~tracer-web/widgets/feed/graph/context/presentation.js";

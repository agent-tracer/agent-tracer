...
import { RuntimeSource, TaskId, TaskSlug } from "~tracer-web/shared/identity.js";
import type { MonitoringTask } from "~tracer-web/entities/task/model/task.js";
import { createUiStore, UiStoreProvider, type UiStoreApi } from "~tracer-web/shared/store/index.js";
...
vi.mock("~tracer-web/entities/task/api/lifecycle-mutations.js", () => ({

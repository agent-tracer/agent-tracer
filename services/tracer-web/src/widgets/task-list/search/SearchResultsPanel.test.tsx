...
import type { EventSearchHit, TaskSearchHit } from "~tracer-web/features/search/model/search.js";
import { createUiStore, UiStoreProvider } from "~tracer-web/shared/store/index.js";
import { TooltipProvider } from "~tracer-web/shared/ui/overlays/Tooltip.js";
...
vi.mock("~tracer-web/features/search/api/queries.js", () => ({

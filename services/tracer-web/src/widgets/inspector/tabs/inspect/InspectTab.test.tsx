...
import * as UiStateModule from "~tracer-web/shared/store/index.js";
import { InspectTab } from "~tracer-web/widgets/inspector/tabs/inspect/InspectTab.js";
...
vi.mock("~tracer-web/entities/task/api/detail-queries.js", () => ({
...
vi.mock("~tracer-web/entities/memo/api/mutations.js", () => ({
...
vi.mock("~tracer-web/shared/store/index.js", async (importOriginal) => {

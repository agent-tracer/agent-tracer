...
import { Tabs, TabsContent } from "~tracer-web/shared/ui/index.js";
import {
  useInspectorTab,
  useSetInspectorTab,
  type InspectorTab as InspectorTabKey,
} from "~tracer-web/shared/store/index.js";
import { InspectorTabs } from "~tracer-web/widgets/inspector/InspectorTabs.js";
...
const TraceTab = lazy(() =>
  import("~tracer-web/widgets/inspector/tabs/trace/TraceTab.js").then((m) => ({ default: m.TraceTab })),
);

...
import type { RuleEvidenceResponse } from "~tracer-web/entities/rule/model/rule-evidence.js";
import type {
  RuleCreateInput,
  RuleRecord,
  RuleUpdateInput,
  RulesListResponse,
} from "~tracer-web/entities/rule/model/rule.js";
import type { RuleDto } from "@agent-tracer/kernel";
import { deleteRequest, getJson, patchJson, postJson } from "~tracer-web/shared/api/client/json-methods.js";
import { toRuleRecord } from "~tracer-web/entities/rule/api/rule.mapper.js";

import type { OnboardingResult } from "~tracer-web/entities/user/model/user.js";
import { postJson } from "~tracer-web/shared/api/client/json-methods.js";
import { setUserIdentity } from "~tracer-web/shared/api/user-identity.js";

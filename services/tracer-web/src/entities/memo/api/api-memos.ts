import type { EventId, TaskId } from "~tracer-web/shared/identity.js";
import type {
  MemoCreateInput,
  MemoRecord,
  MemosListResponse,
  MemoUpdateInput,
} from "~tracer-web/entities/memo/model/memo.js";
...
import { toMemoRecord } from "~tracer-web/entities/memo/api/memo.mapper.js";

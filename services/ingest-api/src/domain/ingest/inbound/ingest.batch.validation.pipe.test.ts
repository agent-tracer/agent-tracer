...
import { MIN_SUPPORTED_CONTRACT_VERSION } from "@agent-tracer/kernel";
import type { BatchRejectedLog, IngestEventLog } from "~ingest-api/domain/ingest/port/ingest.event.log.port.js";

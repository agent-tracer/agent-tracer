...
export const repositoryProviders: Provider[] = [
    ...
    { provide: TurnReassignmentRepository, inject: [TRACER_DATA_SOURCE], useFactory: (ds: DataSource) => new TurnReassignmentRepository(ds.getRepository(TurnReassignmentEntity)) },

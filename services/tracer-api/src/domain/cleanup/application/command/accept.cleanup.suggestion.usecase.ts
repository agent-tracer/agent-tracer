...
import { CLEANUP_ID_GENERATOR, type CleanupIdGeneratorPort } from "~tracer-api/domain/cleanup/port/cleanup.id.generator.port.js";
import {
    CLEANUP_TRANSACTION,
...
export class AcceptCleanupSuggestionUseCase {
    constructor(
        ...
        @Inject(CLEANUP_ID_GENERATOR)
        private readonly idGenerator: CleanupIdGeneratorPort,
    ) {}

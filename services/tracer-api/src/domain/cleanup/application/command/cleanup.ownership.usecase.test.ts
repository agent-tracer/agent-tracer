...
import { TaskCleanupSuggestionEntity, TaskEntity } from "@agent-tracer/tracer-model";
...
function buildAccept(entity: TaskCleanupSuggestionEntity) {
    ...
    return { useCase: new AcceptCleanupSuggestionUseCase(tx, clock, new SequentialCleanupIdGenerator()), tx };
}

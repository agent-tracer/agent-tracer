...
import type { KafkaProducer } from "@agent-tracer/platform";
import * as platform from "@agent-tracer/platform";
import type { NotificationEnvelope } from "@agent-tracer/kernel";
import { KafkaNotificationPublisher } from "./kafka.notification.publisher.adapter.js";

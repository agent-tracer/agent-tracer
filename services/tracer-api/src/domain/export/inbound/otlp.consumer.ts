...
import { OTLP_EVENT_CONSUMER } from "~tracer-api/support/projector.tokens.js";
...
export class OtlpConsumer {
    ...
    async start(): Promise<void> {
        ...
        logInfo({ msg: "kafka.consumer.started", groupId: CONSUMER_GROUP.projectorOtlp, topic: TOPIC.ingestEvents });

...
import { buildOtlpLogsBody, buildOtlpTracesBody, type OtlpEventRecord } from "@agent-tracer/kernel";
import { OTLP_EXPORTER, type OtlpExporterPort } from "~tracer-api/domain/export/port/otlp.exporter.port.js";

...
import { RECIPE_STATUSES, type RecipeStatus } from "@agent-tracer/kernel";
import { RecipeLifecycle, type RecipeEntity } from "@agent-tracer/tracer-model";
import {
...
export class ListRecipesUseCase {
    ...
    private async resolveTaskTitles(
        ...
        const tasks = await this.tasks.findByIds(userId, ids);

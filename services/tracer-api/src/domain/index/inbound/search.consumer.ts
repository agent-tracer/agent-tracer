...
import { recordApplied, recordSkipped } from "~tracer-api/support/metrics.js";
import { parseLedgerRecord } from "~tracer-api/support/ledger.record.js";
import { SEARCH_EVENT_CONSUMER } from "~tracer-api/support/projector.tokens.js";
...
export class SearchConsumer {
    ...
    async start(): Promise<void> {
        ...
        logInfo({ msg: "kafka.consumer.started", groupId: CONSUMER_GROUP.projectorSearch, topic: TOPIC.ingestEvents });

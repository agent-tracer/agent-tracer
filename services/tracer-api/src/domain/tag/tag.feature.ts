import { TagRepository, TaskTagRepository, TransactionRunner } from "@agent-tracer/tracer-model";
import { SystemClock } from "@agent-tracer/platform";
import { TagUlidGenerator } from "~tracer-api/domain/tag/adapter/tag.ulid.generator.js";
...
import { TAG_ID_GENERATOR } from "~tracer-api/domain/tag/port/tag.id.generator.port.js";
...
export const tagFeature = {
    ...
    providers: [
        ...
        { provide: TAG_ID_GENERATOR, useClass: TagUlidGenerator },

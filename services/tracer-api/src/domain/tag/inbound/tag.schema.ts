import { z } from "zod";
import { createTagSchema, setTaskTagsSchema, updateTagSchema } from "@agent-tracer/kernel/tag/tag.schema.js";

export { createTagSchema, setTaskTagsSchema, updateTagSchema };
export type { CreateTagPayload, SetTaskTagsPayload, UpdateTagPayload } from "@agent-tracer/kernel/tag/tag.schema.js";

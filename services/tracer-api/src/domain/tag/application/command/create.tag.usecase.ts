...
import { TAG_ID_GENERATOR, type TagIdGeneratorPort } from "~tracer-api/domain/tag/port/tag.id.generator.port.js";
...
export class CreateTagUseCase {
    constructor(
        ...
        @Inject(TAG_ID_GENERATOR)
        private readonly idGenerator: TagIdGeneratorPort,
    ) {}

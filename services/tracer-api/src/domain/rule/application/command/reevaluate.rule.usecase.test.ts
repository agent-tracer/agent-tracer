...
import { EventEntity, RuleEntity, TurnEntity } from "@agent-tracer/tracer-model";
...
function makeTurn(taskId: string): TurnEntity {
    const turn = TurnEntity.open("session-1", taskId, 1, "github.com/runs/1 확인하고 해결해줘", NOW, "u1");

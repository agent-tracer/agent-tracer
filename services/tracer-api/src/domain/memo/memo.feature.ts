import { MemoRepository, TransactionRunner } from "@agent-tracer/tracer-model";
import { SystemClock } from "@agent-tracer/platform";
import { MemoUlidGenerator } from "~tracer-api/domain/memo/adapter/memo.ulid.generator.js";
...
import { MEMO_ID_GENERATOR } from "~tracer-api/domain/memo/port/memo.id.generator.port.js";
...
export const memoFeature = {
    ...
    providers: [
        ...
        { provide: MEMO_ID_GENERATOR, useClass: MemoUlidGenerator },

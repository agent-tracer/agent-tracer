...
describe("RenameTaskUseCase", () => {
    ...
    it("없는 태스크면 찾을 수 없다고 알린다", async () => {
        ...
        await expect(useCase.execute("u1", "missing", "제목", "user")).rejects.toThrow(NotFoundException);
    });
});

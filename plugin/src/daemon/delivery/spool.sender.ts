import type {AgentTracerPaths} from "~plugin/config/home.paths.js";
import {
    appendDeadLetter,
    appendSpoolLines,
    enforceSpoolSizeCap,
    ...
    spoolBacklogBytes,
    type SpoolSegment,
} from "~plugin/config/spool.js";
import {daemonLog} from "~plugin/daemon/daemon.log.js";
import {sendDaemonHealth, sendIngestBatch} from "~plugin/daemon/delivery/ingest.client.js";
import {MAX_INGEST_BACKOFF_MS, type SendOutcome} from "~plugin/daemon/delivery/ingest.retry.js";
import {collectSpoolBatch, eventIdOfSpoolLine, type SpoolBatch} from "~plugin/daemon/delivery/spool.batch.js";
import type {DaemonHealthTracker} from "~plugin/daemon/lifecycle/daemon.health.js";
import {ownsDaemonPid} from "~plugin/daemon/lifecycle/daemon.pid.js";

import {DAEMON_HEALTH_LAST_DEAD_REASONS_MAX, type DaemonHealthReportPayload} from "@agent-tracer/kernel/daemon/daemon.health.const.js";
...
export function resolveDaemonVersion(root: string = resolvePluginRoot()): string {

...
import type {ReadPendingRecipeMarkUsecase} from "~plugin/domain/recipe/application/read.pending.recipe.mark.usecase.js";
import type {
    RecipeScanRequest,
    RequestRecipeScanUsecase,
} from "~plugin/domain/recipe/application/request.recipe.scan.usecase.js";
import type {ReportRecipeOutcomeUsecase} from "~plugin/domain/recipe/application/report.recipe.outcome.usecase.js";
import type {SearchRecipesInput, SearchRecipesUsecase} from "~plugin/domain/recipe/application/search.recipes.usecase.js";
import type {RecipePendingMark} from "~plugin/domain/recipe/model/recipe.pending.mark.model.js";
import type {RecipeOutcomeReportInput, RecipeOutcomeReportResult} from "~plugin/domain/recipe/port/recipe.outcome.report.port.js";

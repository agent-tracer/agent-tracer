import {
    ...
    TURN_ACTIVITY_TYPE,
    toGenAiMessage,
} from "@agent-tracer/kernel/observability/semconv.const.js";
import type {TurnState} from "~plugin/domain/binding/model/binding.model.js";
import {KIND, LANE, provenEvidence, type RuntimeIngestEvent} from "~plugin/domain/ingest/model/event.model.js";
import {truncateOutput} from "~plugin/support/text.js";

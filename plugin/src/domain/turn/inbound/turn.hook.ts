import type {CloseTurnInput, CloseTurnUsecase} from "~plugin/domain/turn/application/close.turn.usecase.js";
import type {OpenTurnInput, OpenTurnUsecase} from "~plugin/domain/turn/application/open.turn.usecase.js";

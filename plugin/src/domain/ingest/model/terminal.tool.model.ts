import {inferCommandSemantic} from "~plugin/domain/ingest/model/command.semantic.model.js";
import {
    KIND,
    LANE,
    MONITOR_TOOL_NAME,
...
import {collectFileTargets, toOptionalNumber} from "~plugin/domain/ingest/model/file.target.model.js";
import {captureTerminalToolResponse} from "~plugin/domain/ingest/model/tool.capture.model.js";
import {toolUseIdOf, type ShapedToolEvent, type ToolCall} from "~plugin/domain/ingest/model/tool.call.model.js";
import {buildSemanticMetadata} from "~plugin/domain/ingest/model/tool.semantic.model.js";
import type {
    TerminalCommandMetadata,
    ToolUsedMetadata,
} from "~plugin/domain/ingest/model/tool.metadata.model.js";
import {toBoolean, toTrimmedString, truncate} from "~plugin/support/text.js";

...
import {
    ...
    shapeModeChange,
    shapeSkillTool,
} from "~plugin/domain/ingest/model/coordination.tool.model.js";
import {
    EXPLORE_TOOLS,
    shapeExploreTool,
    shapeLspTool,
    shapeToolSearch,
} from "~plugin/domain/ingest/model/explore.tool.model.js";
import {FILE_TOOLS, shapeFileTool} from "~plugin/domain/ingest/model/file.tool.model.js";
import {shapePlanTool, shapeQuestionTool} from "~plugin/domain/ingest/model/interaction.tool.model.js";
import {
    shapeBackgroundShell,
    shapeMonitorCommand,
    shapeTerminalCommand,
} from "~plugin/domain/ingest/model/terminal.tool.model.js";
import type {
    ShapedToolEvent,
    ToolCall,
    ToolShapeContext,

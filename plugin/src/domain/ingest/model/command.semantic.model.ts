import type {
    ...
    CommandStep,
    CommandStructure,
} from "~plugin/domain/ingest/model/command.analysis.model.js";
import {
    ...
    hasDangerousArgs,
    withStep,
} from "~plugin/domain/ingest/model/command.classifier.model.js";
import {analyzeGit} from "~plugin/domain/ingest/model/command.git.model.js";
import {analyzePackageManager} from "~plugin/domain/ingest/model/command.package.model.js";
import {runnerStepFrom, unwrapCommand} from "~plugin/domain/ingest/model/command.runner.model.js";
import {
    extractRedirects,
    isEnvAssignment,
    splitPipeline,
    splitSequence,
    tokenizeShell,
} from "~plugin/domain/ingest/model/command.parser.model.js";
import {containsComplexShell, pathTargets, uniqueTargets, urlTargets} from "~plugin/domain/ingest/model/command.target.model.js";
import type {EventLane} from "~plugin/domain/ingest/model/event.model.js";
import type {EventSemanticMetadata} from "~plugin/domain/ingest/model/tool.metadata.model.js";

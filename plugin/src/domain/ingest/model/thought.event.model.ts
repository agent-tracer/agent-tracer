...
import type {ThoughtLoggedMetadata} from "~plugin/domain/ingest/model/session.metadata.model.js";
import {ellipsize, truncateOutput} from "~plugin/support/text.js";

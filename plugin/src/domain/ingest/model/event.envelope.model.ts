import {AGENT_TRACER_ATTR, GEN_AI_PROVIDER, SEMCONV_ATTR} from "@agent-tracer/kernel/observability/semconv.const.js";
import type {RuntimeIngestEvent} from "~plugin/domain/ingest/model/event.model.js";
import {toIngestEvent, type IngestEvent} from "~plugin/domain/ingest/model/ingest.event.model.js";

import type {CommandStep} from "~plugin/domain/ingest/model/command.analysis.model.js";
import {withStep} from "~plugin/domain/ingest/model/command.classifier.model.js";
import {gitPathspecTargets} from "~plugin/domain/ingest/model/command.target.model.js";

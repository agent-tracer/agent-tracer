...
import type {ToolFailure, ToolShapeContext} from "~plugin/domain/ingest/model/tool.call.model.js";
import {withToolDuration} from "~plugin/domain/ingest/model/tool.duration.model.js";
import {shapeToolFailure} from "~plugin/domain/ingest/model/tool.failure.model.js";
...
import type {ToolTimingPort} from "~plugin/domain/ingest/port/tool.timing.port.js";

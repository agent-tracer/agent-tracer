...
import {RULE_EXPECTATION_KIND} from "@agent-tracer/kernel/rule/definition/rule.vocabulary.js";
import type {RuleProposalPayload} from "@agent-tracer/kernel/rule/proposal/rule.proposal.schema.js";
import {digestEvents, digestExistingRules, digestTurns} from "~plugin/domain/rulegen/model/evidence.model.js";
import {buildRuleOutputSchema} from "~plugin/domain/rulegen/model/output.schema.model.js";
import {
    RULEGEN_REPAIR_ATTEMPTS,
    groundRuleProposals,
} from "~plugin/domain/rulegen/model/proposal.grounding.model.js";
import {CITATION_MAX, validateRuleProposals} from "~plugin/domain/rulegen/model/proposal.validation.model.js";
import type {RulegenProvenanceSnapshot} from "~plugin/domain/rulegen/model/rulegen.provenance.model.js";
import {buildRuleGenerationSpec} from "~plugin/domain/rulegen/model/rulegen.spec.model.js";
import {
    RULEGEN_EVENT_LIMIT,
    RULEGEN_TOOL_SPECS,
...
interface RuleGenerationToolContract {

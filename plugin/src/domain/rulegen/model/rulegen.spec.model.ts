import type {RuleGenerationFocus} from "@agent-tracer/kernel/job/job.const.js";
...
import {defaultMaxRules, resolveRulegenMode, type RulegenMode} from "~plugin/domain/rulegen/model/rulegen.mode.model.js";
import {

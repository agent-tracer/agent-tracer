...
import type {
    RuleAgentRunnerPort,
    RuleAgentRunRequest,
} from "~plugin/domain/rulegen/port/rule.agent.runner.port.js";
...
export class ClaudeRuleAgentRunnerAdapter implements RuleAgentRunnerPort {
    ...
    async *run(request: RuleAgentRunRequest): AsyncIterable<RuleAgentMessage> {
        ...
        const {createRulegenMcpServer} = await import("~plugin/domain/rulegen/adapter/rulegen.tool.schema.js");

...
import {readInstructionsLoaded} from "~plugin/agent/claude-code/payload/workspace.payload.js";
...
import {instructionsLoadedEvent} from "~plugin/domain/ingest/model/workspace.event.model.js";

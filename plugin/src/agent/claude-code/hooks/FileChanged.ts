...
import {readFileChanged} from "~plugin/agent/claude-code/payload/workspace.payload.js";
...
import {fileChangedEvent} from "~plugin/domain/ingest/model/workspace.event.model.js";

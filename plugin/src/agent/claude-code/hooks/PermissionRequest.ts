...
import {readPermissionRequest} from "~plugin/agent/claude-code/payload/tool.payload.js";
...
import {permissionRequestEvent} from "~plugin/domain/ingest/model/workspace.event.model.js";
